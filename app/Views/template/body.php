                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-6">
                        <div class="section-tittle mb-50">
                            <h2>Dengan kamera saya, saya menangkap kehidupan sehari-hari</h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="all-starups-area fix">
            ...
            <div class="starups">
                <div class="starups-details">
                    <h3>Saya Siap Melebihi Harapan</h3>
                    <p>Rasa sakit itu sendiri adalah cinta, pelanggan utama Untuk komponen kutub tangki di Amerika Serikat. Jalannya film, lelakiku yang menghiasi kartun, terkadang tidak ada rasa sakit.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="section-tittle mb-60 text-center">
                            <h2>Hidup adalah tentang Menciptakan Pengalaman</h2>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                            ...
                            <div class="cat-cap">
                                <h5>Kesenangan itu sendiri karena kesenangan</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                            ...
                            <div class="cat-cap">
                                <h5>Untuk setiap moment Kebahagian </h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".8s">
                            ...
                            <div class="cat-cap">
                                <h5>Untuk Kamu yang selalu bahagia</h5>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="h1-testimonial-active dot-style">
                                ...
                                <div class="single-testimonial position-relative">
                                    <div class="testimonial-caption">
                                        ...
                                        <p>"Proses otomatis dimulai segera setelah pakaian Anda masuk ke mesin. Hasil situs ini adalah pakaian yang berkilauan. Teks placeholder biasa digunakan. Dalam penerbitan dan grafik.</p>
                                    </div>
                                    <!-- founder -->
